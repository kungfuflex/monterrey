    ...
    async tick() {
        ...
        if (blockNumber < current) {
            ...
            for (const address in this.tokenConversionRate) {
                let oldBalances = await (0, exports.checkTokenBalances)(wallets, this.provider, blockNumber, address);
                let newBalances = await (0, exports.checkTokenBalances)(wallets, this.provider, newBlockNumber, address);
